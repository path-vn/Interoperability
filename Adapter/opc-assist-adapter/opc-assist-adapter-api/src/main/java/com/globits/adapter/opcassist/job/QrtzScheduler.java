...
import com.globits.adapter.opcassist.job.config.AutoWiringSpringBeanJobFactory;
...
@Configuration
@ConditionalOnExpression("'${using.spring.schedulerFactory}'=='auto'")
public class QrtzScheduler {
	...
	@PostConstruct
	public void init() {
		logger.info("Your Data will be post automatically...");
	}
