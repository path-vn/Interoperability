...
import com.globits.OpcEClinicaAdapterApplication;
...
public class TestCallTemplate {
	...
	public static void getExample() {
		try {
		    // request url
		    String url = "http://test.globits.net:5001/opcassistadapter/1";
	...
	public static void getSSLExample() {
		try {
		    // request url
		    String url = "https://test.globits.net:5000/opcassistadapter/1";
