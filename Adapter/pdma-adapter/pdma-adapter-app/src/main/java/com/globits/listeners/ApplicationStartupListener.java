...
//	private ResourceDefService resDefService;
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		RestTemplateUtils.OpenHimPath =  env.getProperty("openhim.path", String.class);
		RestTemplateUtils.LogPath =  env.getProperty("log.path", String.class);
		if(env.getProperty("client.usingencode")!=null) {
			RestTemplateUtils.IsUsingEncodeData = Boolean.valueOf(env.getProperty("client.usingencode"));
		}
		...
		Integer pageIndex = env.getProperty("mediator.pageIndex",Integer.class);
		if(pageIndex!=null && pageIndex>0) {
			Constants.pageIndex = pageIndex;
		}
		Integer pageSize = env.getProperty("mediator.pageSize",Integer.class);
