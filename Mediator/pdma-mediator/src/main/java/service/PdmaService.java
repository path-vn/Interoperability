...
import Utils.PDMAMediatorConstants;
...
public class PdmaService {
	...
	public QuestionnaireResponseItemComponent generatePatientIdentifying(PdmaDto data) {
		...
		if (data.getFullname() != null) {
			...
			if (data.getEthnic() != null) {
				Valueset coding = PDMAMediatorConstants.getEthnicity(data.getEthnic());
		...
		if (data.getPermanentCommune() != null) {
			...
			QuestionnaireResponseItemComponent permanentCommune = createQRItemCompenentValueCoding(
					HivConst.QRLinkIdCommune, HivConst.QRTextCommune, data.getPermanentCommune().toLowerCase(),
		...
		if (data.getPermanentDistrict() != null) {
			...
			QuestionnaireResponseItemComponent permanentDistrict = createQRItemCompenentValueCoding(
					HivConst.QRLinkIdDistrict, HivConst.QRTextDistrict, data.getPermanentDistrict().toLowerCase(),
		...
		if (data.getPermanentProvince() != null) {
			...
			QuestionnaireResponseItemComponent permanentProvince = createQRItemCompenentValueCoding(
					HivConst.QRLinkIdProvince, HivConst.QRTextProvince, data.getPermanentProvince().toLowerCase(),
		...
		if (data.getPermanentCountry() != null) {
			...
			QuestionnaireResponseItemComponent permanentCountry = createQRItemCompenentValueCoding(
					HivConst.QRLinkIdCountry, HivConst.QRTextCountry, data.getPermanentCountry().toLowerCase(),
	...
	public QuestionnaireResponseItemComponent generateRiskFactors(PdmaDto data) {
		...
		if (data.getRiskPopulation() != null) {
			Valueset coding = PDMAMediatorConstants.getPopulationGroupByText(data.getRiskPopulation().getCode());
	...
	public QuestionnaireResponseItemComponent generateHivDiagnosis(PdmaDto data) {
	...
	public QuestionnaireResponseItemComponent generateHivRecencyTest(PdmaDto data) {
		...
		if (data.getRecency() != null) {
			...
			if (data.getRecency().getTestResultOther() != null) {
				Valueset value = PDMAMediatorConstants.getRapidTestResult(data.getRecency().getTestResultOther());
				if(value  != null) {
				QuestionnaireResponseItemComponent vlRecencyTestResult = createQRItemCompenentValueCoding(
						...
						value.getCode(),value.getDisplay());
	...
	public QuestionnaireResponseItemComponent generateLastestCd4(HivCd4Dto item) {
		...
		// reason test
		Valueset coding = PDMAMediatorConstants.getCD4Valueset(item.getTestReason());
	...
	public QuestionnaireResponseItemComponent generateVlDuringArt(HivViralLoadDto item) {
		...
		if (item.getTestReason() != null) {
			Valueset coding = PDMAMediatorConstants.getVLValueset(item.getTestReason());
		...
		if (item.getResultText() != null) {
			Valueset value = PDMAMediatorConstants.getResultOther(item.getResultText());
			if(value != null) {
			QuestionnaireResponseItemComponent vl4DuringARTTestResult = createQRItemCompenentValueCoding(
					HivConst.QRLinkIdTestResultOther, "Result of other outcome",
					value.getCode(), value.getDisplay());
			vl4DuringART.addItem(vl4DuringARTTestResult);
			}
		}
	...
	public QuestionnaireResponseItemComponent generateDrugResistance(HivDrugResistanceDto item) {
		...
		if (item.getResult() != null) {
			QuestionnaireResponseItemComponent drugResistanceTestTestResult = createQRItemCompenentValueInteger(
					HivConst.QRLinkIdTestResult, "Drug Resistance test result",
	...
	public QuestionnaireResponseItemComponent generateComorbidities(PdmaDto data) {
	...
	public Bundle convertListPdmaObjectToBundle(List<PdmaDto> listDto) {
		Bundle bundle = new Bundle();
		for (PdmaDto data : listDto) {
			...
			QuestionnaireResponseItemComponent orgUnitName = createQRItemCompenentValueCoding(
					...
					HivConst.synOrg.Pdma.getValue().toString(), HivConst.synOrg.Pdma.name());
