...
class SystemAdressCodeImportExcelDialog extends React.Component {
  state = {
    dragClass: "",
    files: [],
    statusList: [],
  ...
  fileUpload(file) {
    const url = ConstantList.API_ENPOINT + "/api/file/import/OpcAssit/importAdministrativeUnit";
...
export default SystemAdressCodeImportExcelDialog;