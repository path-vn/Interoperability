...
var path = "/api/systemAddressCode";
export const getAllSystemAdressCode = () => {
...
export const deleteSystemAdressCode = id => {
  return axios.delete(ConstantList.API_ENPOINT + path + "/" + id);
};
export const addNewSystemAdressCode = adminUnit => {
  return axios.post(ConstantList.API_ENPOINT + path, adminUnit);
};
export const updateSystemAdressCode = (adminUnit, id) => {
