  ...
  search() {
    this.setState({ page: 0 }, function () {
      ...
      getByPage(searchObject, this.state.page, this.state.rowsPerPage).then(({ data }) => {
        this.setState({ administrativeList: [...data.content], totalElements: data.totalElements })
      });
      //this.updatePageData();
    });
  }
...
//-----------------------------------------------------//
  ...
  //       administrativeList: [...data.content], totalElements: data.totalElements
  //     });
  //     console.log(this.state.administrativeList);
  //   }
  //   );
  // };
//------------------------------------------------------//
    ...
    return (
      <div className="m-sm-30">
        <div className="mb-sm-30">
          ...
          <Breadcrumb routeSegments={[{ name: t("Dashboard.directory"), path: "/directory/apartment" }, { name: t('administrativeUnit.title') }]} />
        </div>
